...
mapfile2 <- mapfile2%>% 
  filter(i != 16) #16 just happens to be the layer number for the test file.  You'd need to look at the layers to figure out which is the waterways folder number.
...
st_write(CropWater2, "testcw2-2.kml", driver='kml', update = TRUE)
...
write.csv(CropTable[,1], "testcw2.csv")
